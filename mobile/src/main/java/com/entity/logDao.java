...
public class logDao extends AbstractDao<log, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property OperType = new Property(1, String.class, "operType", false, "OPER_TYPE");
        public final static Property OperTime = new Property(2, String.class, "operTime", false, "OPER_TIME");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'LOG' (" + //
                ...
                "'OPER_TYPE' TEXT," + // 1: operType
                "'OPER_TIME' TEXT," + // 2: operTime
    ...
    protected void bindValues(SQLiteStatement stmt, log entity) {
        ...
        if (operType != null) {
            stmt.bindString(2, operType);
        }
 
        String operTime = entity.getOperTime();
        if (operTime != null) {
            stmt.bindString(3, operTime);
        }
    ...
    public log readEntity(Cursor cursor, int offset) {
        log entity = new log( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // operType
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // operTime
    ...
    public void readEntity(Cursor cursor, log entity, int offset) {
        ...
        entity.setOperType(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setOperTime(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
